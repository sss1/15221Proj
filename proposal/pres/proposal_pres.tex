...
\begin{itemize}
\item A poly-time algorithm using topological sort is known for acyclic graphs
\item Try to find acyclic subgraphs
\item Too many cycles -- took too long to generate subgraphs
\end{itemize}
\item Working backward
\begin{itemize}
\item Tried extending chain of 247 titles using brute force without success
\item Haven't tried adding to the beginning of the chain
