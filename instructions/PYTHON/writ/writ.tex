...
``\texttt{;C:}'' followed by the name of the directory you selected in step 2e.
(for the default directory, add ``\texttt{;C:\textbackslash Python27}''
(without quotes), as shown in Figure \ref{fig:dia8}).
\begin{figure}[h]
\begin{center}
